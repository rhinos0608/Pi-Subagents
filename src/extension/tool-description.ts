...
• Optional context is "fresh" or "fork". Explicit context wins. When omitted, config defaultSubagentContext:"fork" wins over agent defaultContext. timeoutMs/maxRuntimeMs apply to foreground and async workflows; foreground workflows default to 30 minutes and async workflows have no default timeout. Omit acceptance for reviewer/read-only calls; evidence levels end at verified, and acceptance.review.required requests independent writer review.
...
• context can be fresh or fork. Explicit context wins; omitted context follows defaultSubagentContext:"fork" before agent defaultContext. timeoutMs/maxRuntimeMs apply to foreground and async workflows; foreground workflows default to 30 minutes and async workflows have no default timeout. Omit acceptance for reviewer/read-only calls.

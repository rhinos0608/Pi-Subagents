...
• SINGLE CHILD: { agent:"worker", task:"..." }. This structured form starts exactly one direct child. Fields such as model, context, cwd, worktree, budgets, acceptance, and async apply to that child. Do not combine agent/task with action or workflowScript.
